...
function HeroSection() {
  ...
  // Budget options
  const budgetOptions = [
    { value: "small", label: "< $5,000", color: "from-blue-400 to-blue-500" },
    { value: "medium", label: "$5,000 - $15,000", color: "from-purple-400 to-purple-500" },
    { value: "large", label: "$15,000 - $30,000", color: "from-indigo-400 to-indigo-600" },
    { value: "enterprise", label: "$30,000+", color: "from-pink-400 to-pink-600" },
  ]

  // Service icons mapping - using Lucide icons for more professional look
  const serviceOptions = [
    { id: "website", name: "Website Development", icon: <Globe className="w-6 h-6 text-blue-300" /> },
    { id: "seo", name: "SEO Optimization", icon: <BarChart2 className="w-6 h-6 text-green-300" /> },
    { id: "design", name: "Design Services", icon: <Palette className="w-6 h-6 text-purple-300" /> },
    { id: "marketing", name: "Digital Marketing", icon: <TrendingUp className="w-6 h-6 text-pink-300" /> },
  ]
    ...
    >
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10 py-16 md:py-24 lg:py-32">
        <div className="flex flex-col md:flex-row items-center justify-between gap-12">
          ...
          <AnimatedSection className="w-full md:w-1/2" delay={0.4} threshold={0.2}>
            <motion.div
                    ...
                    {[1, 2, 3].map((step) => (
                      ...
                      >
                        ...
                        <span className="text-xs text-blue-100">
                          {step === 1 ? "Info" : step === 2 ? "Project" : "Details"}
                        </span>
                      </div>
                    ))}
                  </div>
              ...
              {!isSubmitted ? (
                <form onSubmit={handleSubmit} className="p-6">
                  ...
                  {currentStep === 1 && (
                    ...
                    >
                      <div>
                        ...
                        <div className={`relative ${focusedField === "name" ? "ring-2 ring-blue-500 rounded-lg" : ""}`}>
                          <input
                            type="text"
                            id="name"
                            name="name"
                      ...
                      <div>
                        ...
                        <div
                          className={`relative ${focusedField === "email" ? "ring-2 ring-blue-500 rounded-lg" : ""}`}
                        >
                          <input
                            type="email"
                            id="email"
                      ...
                      <div>
                        ...
                        <div
                          className={`relative ${focusedField === "phone" ? "ring-2 ring-blue-500 rounded-lg" : ""}`}
                        >
                          <input
                            type="tel"
                            id="phone"
                  ...
                  {currentStep === 2 && (
                    ...
                    >
                      <div>
                        <label className="block text-sm font-medium text-blue-100 mb-3">Service Needed*</label>
                      ...
                      <div>
                        <label className="block text-sm font-medium text-blue-100 mb-3">Estimated Budget</label>
                          ...
                          {budgetOptions.map((option) => (
                            ...
                            >
                              <div className="flex justify-between items-center">
                                <span className="text-sm text-blue-100">{option.label}</span>
                                {formState.budget === option.value && (
                                  <motion.div
                  ...
                  {currentStep === 3 && (
                    ...
                    >
                      <div>
                        ...
                        <div
                          className={`relative ${focusedField === "message" ? "ring-2 ring-blue-500 rounded-lg" : ""}`}
                        >
                          <textarea
                            id="message"
                            name="message"
                        ...
                        <div className="space-y-2 text-sm">
                          ...
                          <div className="flex justify-between">
                            ...
                            <span className="text-white flex items-center">
                              {serviceIconsMap[formState.service] && (
                                <span className="mr-1">{serviceIconsMap[formState.service]}</span>
                              )}
                          ...
                          <div className="flex justify-between">
                            ...
                            <span className="text-white">
                              {budgetOptions.find((o) => o.value === formState.budget)?.label || ""}
                            </span>
                          </div>
                        </div>
                      </div>
        ...
        >
          ...
          >
            <div className="text-center">
              ...
              <p className="text-blue-100 mb-6">
                Your request has been submitted successfully. Our team will analyze your needs and get back to you with
                a custom proposal.
              </p>
              ...
              <div className="flex flex-col space-y-3">
                <div className="flex items-center justify-between p-3 bg-white/10 rounded-lg">
                  ...
                  <span className="text-xs bg-blue-500/20 text-blue-300 py-1 px-2 rounded-full">In Progress</span>
                </div>
